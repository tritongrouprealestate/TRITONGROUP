...
(function () {
  ...
  const E = [
    ...
    ["dimensional analysis", "Checking or building a formula by making sure the units (mass M, length L, time T) match on both sides. Mismatched units always mean a wrong formula.", "[force] = M L T⁻²", "It predicts that a pendulum's period goes as √(L/g) without any calculus.", "academy"],
    ["stress", "The force acting on each square metre inside a material when it is stretched, squeezed or twisted.", "stress = F / A  (unit: Pa)", "The steel cable holding a lift is under tensile stress.", "academy", ["tensile stress"], 1],
    ["heat engine", "A machine that turns some heat into work and dumps the rest as waste heat at a lower temperature. Car engines and power stations are heat engines.", "η = W / Q_in = 1 − Q_out / Q_in", "No heat engine can be 100% efficient. The second law of thermodynamics forbids it.", "academy", ["heat engines"]],
    ["polarisation", "Light waves wiggle sideways. In polarised light they all wiggle in one direction. Only transverse waves can be polarised.", "Malus's law: I = I₀ cos²θ", "Polarised sunglasses block glare reflected off water and roads.", "academy", ["polarization", "polarised light"]],
    ["inverse-square law", "When something spreads out evenly from a point, its strength falls as 1/distance². Double the distance and you get a quarter.", "I ∝ 1/r²", "Gravity, starlight and electric force all follow it.", "newton", ["inverse square law"]],
    ["free fall", "Moving under gravity alone, with nothing else pushing. Everything in free fall accelerates together, so it all feels weightless.", "a = g", "Astronauts on the ISS float because they are always falling around Earth.", "newton", ["weightlessness"]],
    ["angular size", "How big something looks, measured as an angle. The farther away it is, the smaller it looks.", "θ (in radians) ≈ size / distance", "The Sun and the Moon both cover about 0.5°, which is why total solar eclipses can happen.", "sky", ["angular diameter"]],
    ["Coriolis effect", "On a spinning Earth, anything moving over long distances seems to curve: to the right in the northern hemisphere, to the left in the southern.", "a = 2Ωv sin(latitude)", "It makes cyclones spin. It is far too weak to steer the water in a sink.", "myths", ["Coriolis force"]],
    ["declination", "A star's latitude on the sky: how far north (+) or south (−) of the celestial equator it sits, in degrees.", "noon Sun altitude = 90° − |latitude − declination|", "The Sun's declination swings between +23.44° in June and −23.44° in December.", "sky"],
    ["circumpolar", "A star close enough to the celestial pole that it never sets from where you are. It circles the pole all night.", "circumpolar if declination > 90° − latitude", "From Delhi, Kochab in the Little Dipper never sets.", "sky", ["circumpolar star"]],
    ["sidereal day", "The time Earth takes to spin once relative to the distant stars: 23 h 56 min 4 s, about 4 minutes shorter than a solar day.", "solar day − sidereal day ≈ 3 min 56 s", "This is why each star rises about 4 minutes earlier every night.", "sky"],
    ["circumference", "The distance all the way around a circle or sphere.", "C = 2πr", "Earth's circumference is about 40,000 km.", "heroes", null, 1],
    ["speed of light", "The fastest anything can travel through space. Light in a vacuum covers about 3 lakh km every second.", "c = 299,792,458 m/s ≈ 3 × 10⁸ m/s", "Sunlight takes about 8 minutes 20 seconds to reach Earth.", "spacetime"],
    ["relative velocity", "The velocity of one thing as seen from another moving thing. Subtract the observer's velocity.", "v_AB = v_A − v_B", "Two trains passing at 60 km/h each seem to rush past each other at 120 km/h.", "academy"],
    ["Young's modulus", "How stiff a material is when stretched: stress divided by strain. A bigger number means harder to stretch.", "Y = (F/A) / (ΔL/L)", "Steel's is about 2 × 10¹¹ Pa. Rubber's is only about 10⁶ Pa.", "academy"],
    ["Newton's law of cooling", "A hot object cools faster when it is much hotter than its surroundings, and more slowly as the gap shrinks.", "rate of cooling ∝ (T − T_surroundings)", "Your tea cools quickly at first, then slowly.", "academy"],
    ["latent heat", "The heat needed to change a substance's state (melt or boil it) without changing its temperature.", "Q = mL,  L for melting ice = 336 J/g", "Ice at 0 °C must absorb 336 J per gram just to become water at 0 °C.", "academy"],
    ["capacitor", "A device that stores electric charge and energy, usually two metal plates separated by an insulator.", "C = Q/V,  energy = ½CV²", "A camera flash dumps a capacitor's stored energy in a split second.", "academy", ["capacitors"]],
    ["angle of dip", "The angle Earth's magnetic field makes with the horizontal. A compass needle free to tilt points down by this angle.", "tan δ = B_V / B_H", "It is 0° on the magnetic equator, near Thumba in Kerala, and 90° at the magnetic poles.", "academy", ["dip angle", "magnetic dip"]],
    ["radiation pressure", "Light carries momentum, so it pushes on whatever absorbs or reflects it. The push is tiny, but it never stops.", "P = I/c (absorbed),  2I/c (reflected)", "Solar sails like Japan's IKAROS used it to travel without fuel.", "ready"],
    ["doping", "Adding a tiny amount of another element to a pure semiconductor to give it extra electrons (n-type) or holes (p-type).", "nₑ × nₕ = nᵢ²", "One impurity atom per million silicon atoms raises its conductivity roughly a million times.", "academy", ["dopant"]]
  ];
